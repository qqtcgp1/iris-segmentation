FILE = '/Users/yuquan/Downloads/OneDrive/Dropbox/de_terminal copy/Matlab_output.dat';
scale_factor = 0.027;
num_replicates = 40;
...
fprintf(fileID, '<boundary node set>\n');
...
FILE = '/Users/yuquan/Downloads/OneDrive/Dropbox/de_terminal copy/true_data.dat';
fileID = fopen(FILE, 'w');
